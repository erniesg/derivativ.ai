...
class QuestionGeneratorAgent(BaseAgent):
    ...
    async def _execute(self, input_data: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            self._observe(f"Generation failed: {e!s}")
    ...
    async def _generate_question_with_retries(
    ...
    async def _generate_question_primary(
        ...
        try:
            ...
            extraction_result = await self.json_parser.extract_json(
                llm_response.content, model_name=request.llm_model.value
            )
...
Return JSON with: question_text, marks, command_word, solution_steps, final_answer"""
            ...
            if extraction_result.success:
                return await self._convert_to_question_object(
                    extraction_result.data, request, is_fallback=True
                )
    ...
    async def _convert_to_question_object(
        self, json_data: dict[str, Any], request: GenerationRequest, is_fallback: bool = False
    ) -> Question:
        ...
        try:
            ...
            taxonomy = QuestionTaxonomy(
                ...
                subject_content_references=request.subject_content_refs
                or [SubjectContentReference.C1_1],
    ...
    async def generate_multiple_questions(self, request: GenerationRequest) -> list[Question]:
