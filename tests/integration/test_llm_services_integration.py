...
class TestGeminiServiceIntegration:
    ...
    @patch("src.services.gemini.genai.GenerativeModel")
    @pytest.mark.asyncio
    async def test_generate_with_safety_settings(self, mock_model_class, mock_configure, gemini_config):
    ...
    @patch("src.services.gemini.genai.GenerativeModel")
    @pytest.mark.asyncio
    async def test_free_tier_cost_calculation(self, mock_model_class, mock_configure, gemini_config):
...
class TestLLMFactoryIntegration:
    ...
    def test_router_with_real_config(self, mock_gemini, mock_anthropic, mock_openai, factory_config):
