...
class TestSmolagentsLiveIntegration:
    ...
    def test_live_workflow_complete(self):
        ...
        quality_score = review_data.get("quality_score") or review_data.get("quality_decision", {}).get("overall_score", 0.5)
    ...
    def test_smolagents_interactive_live(self):
        ...
        try:
            result = agent.run(
                "Generate a simple algebra question for grade 8, worth 3 marks"
            )
