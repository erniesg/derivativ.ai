...
class JSONExtractionResult(BaseModel):
    ...
    thinking_tokens_removed: bool = Field(False, description="Whether thinking tokens were found and removed")
...
class JSONParser:
    ...
    async def extract_json(
        ...
        cleaned_response, thinking_tokens_removed = self._clean_thinking_tokens(response, model_name)
    ...
    def _clean_thinking_tokens(self, text: str, model_name: Optional[str]) -> Tuple[str, bool]:
        ...
        if first_brace > 0:
            ...
            thinking_indicators = [
                'let me', 'i need to', 'first', 'okay', 'sure', 'here\'s', 
                'to solve', 'let\'s', 'i\'ll', 'thinking', 'reasoning'
            ]
    ...
    def _is_thinking_model(self, model_name: str) -> bool:
        ...
        thinking_patterns = [
            'qwen', 'deepseek', 'thinking', 'reasoning', 'o1-', 'o3-', 'o1', 'o3'
        ]
