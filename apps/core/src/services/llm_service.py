...
from ..models.enums import LLMModel, LLMProvider
...
class MockLLMService(LLMService):
    ...
    def _generate_mock_content(self, prompt: str, model: LLMModel) -> str:
        ...
        if any(keyword in prompt_lower for keyword in ["generate", "question", "mathematics", "igcse"]):
        ...
        elif any(keyword in prompt_lower for keyword in ["review", "quality", "assess", "feedback"]):
